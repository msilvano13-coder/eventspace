...
export default function WeddingEditor({ event, onSave, onHeroUpload, backHref, infoNotes }: WeddingEditorProps) {
  // ── Form state ──
  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="flex items-center gap-3 mb-6">
        <a href={backHref} className="text-stone-400 hover:text-stone-600">
          <ArrowLeft size={20} />
        </a>
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white rounded-xl border border-stone-200 p-5">
          ...
          <p className="text-xs text-stone-400 mb-3">Reorder your page sections. Empty sections are automatically hidden.</p>
